...
tt = TextTransform.new

raise 'rust fail' unless cash_flow(10000, 800, 50, 30, 5) == TextTransform.cash_flow_class(10000, 800, 50, 30, 5)
...
Benchmark.ips do |x|
  ...
  x.report("rust cash_flow class") { TextTransform.cash_flow_class(10000, 800, 50, 30, 5) }
